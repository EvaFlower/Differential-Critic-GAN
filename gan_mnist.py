"""
Code is from https://github.com/caogang/wgan-gp
"""
...
#run = 0
output_path = os.path.join(output_path) #, str(run))
...
for iteration in tqdm(range(ITERS)):
    ...
    if use_tensorboard:
        writer.add_scalars('d_out', {'real': D_real, 'fake': D_fake}, iteration)
        #writer.add_scalars('loss', {'d_loss': (d_out_fake-d_out_real), 'r_loss':r_loss_d}, counter)
